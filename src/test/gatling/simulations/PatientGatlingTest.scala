...
class PatientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Patient entity")
        ...
        .repeat(2) {
            ...
            .post("/api/patients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "fname":"SAMPLE_TEXT", "lname":"SAMPLE_TEXT", "dateOfBirth":"2020-01-01T00:00:00.000Z", "email":"SAMPLE_TEXT", "phoneNumber":"SAMPLE_TEXT", "bloodType":null, "otherInfo":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
