(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('hospitalApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-hospitalApp-error');
                var entityKey = httpResponse.headers('X-hospitalApp-params');
                if (errorHeader) {
